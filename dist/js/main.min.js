...
console.log("custom.js"),$("h1").on("click",function(){alert("Done dudo!!")});
console.log("Hello World"),console.log("Test Starter"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!"),console.log("Hello World !!??!");